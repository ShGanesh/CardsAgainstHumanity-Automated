...
def black(j): 	# Select and print BlackCard Statement. Returns BlackCard statement and number of whitespaces.
...
while True:
	...
	if x:
		...
		a.write("\n")
		a.close()
	c = input(("\n\n Continue? (any character other than y or Y will be considered NO): "))
	if c == 'Y' or c == 'y':
		i += 1
		pass
	else:
		print(" Thenks for playing this game for,", i, "iteration(s)")
		break
